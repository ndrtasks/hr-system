...
['الفترة غير واضحة.','الفترة غير واضحة، لذلك المدير ما يعرف هل الرقم شهري أو سنوي أو محسوب على آخر 12 شهرا.'],
['نوع الدوران غير محدد.','نوع الدوران غير محدد، لذلك ما نعرف هل النسبة للدوران الطوعي أو الإجمالي أو لفئة موظفين محددة.']
]
};
let count=0;
